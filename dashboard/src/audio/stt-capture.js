// VENDORED from MohammadBnei/ukubi-stt (web/stt-capture.js). Do not edit here.
//
// Copied rather than imported from https://stt.bnei.dev/stt-capture.js: a
// cross-origin module import would make the composer's microphone break
// whenever the GPU node reboots for gaming, turning a degraded feature into a
// broken one. Re-copy when ukubi-stt changes it.
//
// The chunk arithmetic in here carried three separate latency bugs; it exists
// once upstream so the fourth is found once.
