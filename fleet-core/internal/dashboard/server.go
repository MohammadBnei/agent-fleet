...
// same tasks.Store / transcript.Store / e2eclient.Client that fleet-core's
...
func NewServer(taskStore *tasks.Store, transcr transcript.Store, e2e *e2eclient.Client, hub *Hub) *Server {
...
// fleet-core/internal/discord/handlers.go's /approve, /stop, and
