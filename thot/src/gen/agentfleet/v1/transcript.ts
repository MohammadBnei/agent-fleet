...
export const TranscriptEntry: MessageFns<TranscriptEntry> = {
  encode(message: TranscriptEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.replyTo !== undefined) {
      writer.uint32(48).int64(message.replyTo);
    }
    return writer;
  },
...
export const AppendTranscriptEntryRequest: MessageFns<AppendTranscriptEntryRequest> = {
  encode(message: AppendTranscriptEntryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.taskId !== "") {
      writer.uint32(10).string(message.taskId);
    }
    if (message.from !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AppendTranscriptEntryRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ReadTranscriptSinceRequest: MessageFns<ReadTranscriptSinceRequest> = {
  encode(message: ReadTranscriptSinceRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.taskId !== "") {
      writer.uint32(10).string(message.taskId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReadTranscriptSinceRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ReadTranscriptSinceResponse: MessageFns<ReadTranscriptSinceResponse> = {
  encode(message: ReadTranscriptSinceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.entries) {
      TranscriptEntry.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextSeq !== 0) {
      writer.uint32(16).int64(message.nextSeq);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ReadTranscriptSinceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.nextSeq = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
