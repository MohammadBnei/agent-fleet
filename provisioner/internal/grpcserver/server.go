...
func (s *Server) CreateWorkerPod(ctx context.Context, req *agentfleetv1.CreateWorkerPodRequest) (*agentfleetv1.CreateWorkerPodResponse, error) {
	...
	if err := s.k8sc.CreateWorkerPod(ctx, req.GetTaskId(), req.GetRepo(), req.GetDescription(), req.GetLeaseId(), req.GetBaseBranch(), worktreePath, req.GetResumeSessionId()); err != nil {
